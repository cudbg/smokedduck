select groups.*,  l2.rowid as lineitem_rowid_0
from (
    SELECT s_name, count(*) over (partition by s_name) AS numwait,
      supplier.rowid as supplier_rowid, l1.rowid as lineitem_rowid,
...
lineitem as l2 on (l2.l_orderkey = groups.l_orderkey AND l2.l_suppkey <> groups.l_suppkey)
